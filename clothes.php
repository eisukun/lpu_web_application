    ...
    <div style="float:left" >
        <div class="pic_group">
            <div class="pic_option">
                <h1 style="text-align:center; margin-top:10px; font-size:30px; font-family:Tahoma; color:black">Apparel Collection</h1>
                <div class="dropdown">
                ...
                <div class="row">
                    <script>
                        const perfumeItems = [
                            { name: "Plain Shirt", price: 50 },
                            { name: "Plain Tank Top", price: 50 },
                            { name: "One Piece Dress", price: 500 },
                            { name: "Chino Pants", price: 150 },
                            { name: "Sports Bra", price: 110 },
                            { name: "Varsity Jacket", price: 200 },
                            { name: "Plain Hoodie", price: 160 },
                            { name: "Summer Bikini", price: 200 },
                            { name: "Pencil Skirt", price: 60 },
                            { name: "Jogger Pants", price: 60 },
                            { name: "Cargo Shorts", price: 80 },
                            { name: "Summer Polo", price: 120 },
                            { name: "Plain Poloshirt", price: 100 },
                            { name: "Tuxedo", price: 1200 },
                            { name: "Denim Pants", price: 400 },
                            { name: "Denim Jacket", price: 300 },
                            { name: "Plain Slacks", price: 140 },
                            { name: "Pants w/ Frills", price: 100 },
                            { name: "Mini Skirt", price: 90 },
                            { name: "Men's Undies", price: 50 }
                        ];
                        ...
                        for (let i = 0; i < perfumeItems.length; i++) {
                            ...
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src="sde images/clothes_images/${i + 1}.jpg" data-toggle="tooltip" data-placement="center" title="pasta" width="170" height="180" alt="${item.name}" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px">
                                        <div>

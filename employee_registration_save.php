...
<body>
    <div class="d-flex">
        <div class="vh-100 sticky-top bg-dark" style="width: 280px;">
            ...
            <ul class="nav flex-column mb-auto">
                ...
                <li>
                    <a href="employee_registration_save.php" class="nav-link mb-4">
    ...
    <div class="container">
        <div class="page_border">
            ...
            <h1 style="text-align:center; margin-bottom:30px; font-size:47px; font-family:Tahoma; color:black"><b>Rian's Store Employee Personal Information</b></h1>

    ...
    <div style="float:left" >
        <div class="pic_group">
            <div class="pic_option">
                <h1 style="text-align:center; margin-top:10px; font-size:30px; font-family:Tahoma; color:black">Laptop Dex</h1>
                <div class="dropdown">
                ...
                <div class="row">
                    <script>
                        const perfumeItems = [
                            { name: "Acer Nitro 16", price: 79000 },
                            { name: "Aorus 15P", price: 57000 },
                            { name: "Acer Aspire 7", price: 40000 },
                            { name: "Asus TUF F15", price: 46000 },
                            { name: "Asus VivoBook 15", price: 48000 },
                            { name: "Dell Inspiron 3511", price: 26000 },
                            { name: "Dell XPS 15", price: 150000 },
                            { name: "Gigabyte G5", price: 46000 },
                            { name: "Helios Neo 16", price: 68000 },
                            { name: "Helios Predator 300", price: 61000 },
                            { name: "HP Omen 16", price: 78000 },
                            { name: "HP Pavilion 15", price: 50000 },
                            { name: "HP Victus 16", price: 41000 },
                            { name: "MSI Katana GF66", price: 55000 },
                            { name: "Lenovo Legion 5", price: 56000 },
                            { name: "Lenovo Ideapad 330", price: 25000 },
                            { name: "MacBook Air", price: 48000 },
                            { name: "MSI GF63 Thin", price: 41000 },
                            { name: "Asus VivoBook S15", price: 43000 },
                            { name: "Asus ROG Zephyrus G15", price: 126000 }
                        ];
                        ...
                        for (let i = 0; i < perfumeItems.length; i++) {
                            ...
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src="sde images/laptop_images/${i + 1}.jpg" data-toggle="tooltip" data-placement="center" title="pasta" width="170" height="180" alt="${item.name}" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px">
                                        <div>

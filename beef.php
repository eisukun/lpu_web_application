    ...
    <div style="float:left" >
        <div class="pic_group">
            <div class="pic_option">
                <h1 style="text-align:center; margin-top:10px; font-size:30px; font-family:Tahoma; color:black">Beef Dishes</h1>
                <div class="dropdown">
                ...
                <div class="row">
                    <script>
                        const perfumeItems = [
                            { name: "Beef Noodle Salad", price: 150 },
                            { name: "Mushroom Tenderloin", price: 150 },
                            { name: "Beef Lasagna Soup", price: 150 },
                            { name: "Cajun Sirloin", price: 150 },
                            { name: "Chili Hash", price: 150 },
                            { name: "Beef N Bean Pizza", price: 150 },
                            { name: "Saucy Skillet Lasagna", price: 150 },
                            { name: "Mexi-mac Skillet", price: 150 },
                            { name: "Beef Skillet", price: 150 },
                            { name: "Weekday Beef Stew", price: 150 },
                            { name: "Greek Sloppy Joes", price: 150 },
                            { name: "Veggie Beef Soup", price: 150 },
                            { name: "Sesame Beef Skewers", price: 150 },
                            { name: "Cheeseburger Pizza", price: 150 },
                            { name: "Cheeseburger Pasta", price: 150 },
                            { name: "Beef and Veggie Pot", price: 150 },
                            { name: "Cabbage Roll Soup", price: 150 },
                            { name: "Spinach Beef Soup", price: 150 },
                            { name: "Papa Burger", price: 150 },
                            { name: "Speedy Shepherd Pie", price: 150 }
                        ];
                        ...
                        for (let i = 0; i < perfumeItems.length; i++) {
                            ...
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src="sde images/beef_dishes/${i + 1}.jpg" data-toggle="tooltip" data-placement="center" title="pasta" width="170" height="180" alt="${item.name}" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px">
                                        <div>

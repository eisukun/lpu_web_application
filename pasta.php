...
<div class="container"> 
    ...
    <div style="float:left" >
        <div class="pic_group">
            <div class="pic_option">
                <h1 style="text-align:center; margin-top:10px; font-size:30px; font-family:Tahoma; color:black">Pasta Dishes</h1>
                <div class="dropdown">
                ...
                <div class="row">
                    <script>
                        const perfumeItems = [
                            { name: "Baked Feta", price: 150 },
                            { name: "Baked Ravioli", price: 150 },
                            { name: "Cheese Tortellini", price: 150 },
                            { name: "Chicken Penne", price: 150 },
                            { name: "Chicken Pesto", price: 150 },
                            { name: "Shrimp Pasta", price: 150 },
                            { name: "Tomato Pasta", price: 150 },
                            { name: "Chicken Lasagna", price: 150 },
                            { name: "Farfalle Pasta", price: 150 },
                            { name: "Fettucine Alfredo", price: 150 },
                            { name: "Hamburger Helper", price: 150 },
                            { name: "Lemon Butter Pasta", price: 150 },
                            { name: "Baked Ziti", price: 150 },
                            { name: "Pesto Penne", price: 150 },
                            { name: "Pasta Alfredo", price: 150 },
                            { name: "Spaghetti Meatballs", price: 150 },
                            { name: "Stuffed Shells", price: 150 },
                            { name: "Tagliatelle Pasta", price: 150 },
                            { name: "Turkey Tetrazzini", price: 150 },
                            { name: "Vegan Bolognese", price: 150 }
                        ];
                        ...
                        for (let i = 0; i < perfumeItems.length; i++) {
                            ...
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src="sde images/pasta_images/${i + 1}.jpg" data-toggle="tooltip" data-placement="center" title="pasta" width="170" height="180" alt="${item.name}" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px">
                                        <div>
    ...
    <div class="row">
        ...
        <div>
            <!-- Calculator Display -->
            <input type="text" id="calculatorInput" class="form-control" readonly>
        </div>
        <div>
